...
/* env_update.c */
void	upd_env_value(t_minishell *ms, char *key, char *value, int exported);

/* env_create.c */
void	new_env_value(t_minishell *ms, char *key, char *value, int exported);
...
/* cmd_util.c */
void	print_expand_var(t_cmd *cmd, int idx, int *pos, t_minishell *minishell);
